            ...
            if(count($spRes) > 0){
                for ($x = 0; $x < count($spRes); ++$x) {
                    ...
                    foreach ($ids as $id){
                        ...
                        if (false !== strpos(strtolower($id), strtolower($searchStr))) {
                            $idContains = true;
                        }
                    }
                    ...
                    $urlContains = false;
                    if (false !== strpos($uri, $searchStr)) {
                        $urlContains = true;
                    }

                    $titleContains = false;
                    if (false !== strpos(strtolower($spRes[$x]['title']), strtolower($searchStr) )) {
                        $titleContains = true;
                    }

                    $altTitleContains = false;
                    if (false !== strpos(strtolower($spRes[$x]['altTitle']), strtolower($searchStr) )) {
